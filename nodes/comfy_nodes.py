...
class EasyControlLoadFlux:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "local_model_path": ("STRING", {"default": "/runpod-volume/downloads/FLUX.1-dev"}),
            },
    ...
    def load_model(self, local_model_path, load_8bit, cpu_offload):
...
class EasyControlLoadLora:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "local_model_path": ("STRING", {"default": "/runpod-volume/downloads/loras/model.safetensors"}),
    ...
    def load_lora(self, transformer, local_model_path, lora_weight, cond_size):
        set_single_lora(transformer, local_model_path, lora_weights=[lora_weight], cond_size=cond_size)
        return (transformer,)
